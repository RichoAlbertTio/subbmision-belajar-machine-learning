...
# Baca dataset
file_path_day = '/home/adminuser/subbmision-belajar-machine-learning/data/day.csv'  # Ganti dengan path sebenarnya ke file CSV Anda
file_path_hour = '/home/adminuser/subbmision-belajar-machine-learning/data/hour.csv'  # Ganti dengan path sebenarnya ke file CSV Anda
